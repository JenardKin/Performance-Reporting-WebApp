...
urlpatterns = [
    ...
    path('editsTable/', TemplateView.as_view(template_name='editsTable.html'), name='edits-table'),

    path('siteconfig/', TemplateView.as_view(template_name='siteconfig.html'), name='site-config'),
    path('eventsData/', TemplateView.as_view(template_name='eventsData.html'), name='events-data'),
    path('energyData/', TemplateView.as_view(template_name='energyData.html'), name='energy-data'),
